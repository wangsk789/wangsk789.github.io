...
1. 初始化一个变量，记录key
   ![20250303_121009.png](https://gitee.com/wangsk789/images/raw/master/20250303_121009.png)

2. 构造请求URL
   ![20250303_121026.png](https://gitee.com/wangsk789/images/raw/master/20250303_121026.png)
...
3. 因为关系到网络的传输，速度不确定，所以get请求这个动作，有个异步的`HTTP客户端.获得文本`这个事件，我们就用它来接受返回的结果,并显示在调试窗口。
   ![20250303_121045.png](https://gitee.com/wangsk789/images/raw/master/20250303_121045.png)

现在就可以连接手机，在文本框中填入城市名称，运行app看看返回值如何。（尽管文档中明确说参数如果是中文的，需要进行url编码，但是这里我们直接输入中文城市名，貌似也可以）

在设计界面右侧的调试信息窗口，显示如图：
![20250303_121118.png](https://gitee.com/wangsk789/images/raw/master/20250303_121118.png)
...
1. 碰到`{` 左侧花括号的，就用`在键值列表...中查找...` 提取
   ![20250303_121140.png](https://gitee.com/wangsk789/images/raw/master/20250303_121140.png)

2. 碰到 `[` 左侧方括号，就用`选择列表...第...项` 提取
   ![20250303_121156.png](https://gitee.com/wangsk789/images/raw/master/20250303_121156.png)
...
![20250303_121219.png](https://gitee.com/wangsk789/images/raw/master/20250303_121219.png)
...
- keyPath 要提取的键的路径，键名或索引值用半角逗号隔开
  ...
  可以这样组织代码：
![20250303_121239.png](https://gitee.com/wangsk789/images/raw/master/20250303_121239.png)
...
2. 解析json字串不用**http客户端.解析json**文本了，可以使用字典内置的**json转字典**
   ...
   ![20250303_121246.png](https://gitee.com/wangsk789/images/raw/master/20250303_121246.png)
